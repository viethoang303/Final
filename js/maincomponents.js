    ...
    <div class="homepage-container" id ="homepage">
        <div class="category">
            ...
            <div class="cover-image">
                <figure>
                    <div class="image">
                        <img src="./imgs/collections.jpg" class = "cover-image" id="imgCollections">
                    </div>
        ...
        <div class="category">
            ...
            <div class="cover-image">
                <figure>
                    <div class="image">
                        <img src="./imgs/men.jpg" class="cover-image" id="imgMen">
                    </div>
                </figure>
            </div>
        </div>
        <div class="category">
            ...
            <div class="cover-image">
                <figure>
                    <div class="image">
                        <img src="./imgs/women.jpg" class="cover-image" id="imgWomen">
                    </div>
                </figure>
            </div>
        </div>
        <div class="category">
            ...
            <div class="cover-image">
                <figure>
                    <div class="image">
                        <img src="./imgs/kids.jpg" class="cover-image" id="imgKids">
                    </div>
                </figure>
            </div>
        </div>
